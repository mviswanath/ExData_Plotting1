...
#-----------------------------------------------------
# Plot 4.0 - Setup for a 2x2 plots
#-----------------------------------------------------
png(filename = "plot4.png", width = 480, height = 480)
par(mfcol = c(2,2))

#-----------------------------------------------------
# Plot 4.1 - Add plot 2 - Global Active Power consumption
#-----------------------------------------------------
...
#-----------------------------------------------------
# Plot 4.2 - Add plot 3 - Data on energy sub metering
#-----------------------------------------------------
...
#-----------------------------------------------------
# Plot 4.3 - Voltage consumed on Feb 1st and Feb 2nd 2007
#-----------------------------------------------------

plot(B$Mod_Date, B$Voltage, type="n", ylab = "Voltage", xlab ="datetime")
lines(B$Mod_Date,B$Voltage)

#-----------------------------------------------------
# Plot 4.4 - Plot Global Reactive Power on Feb 1st and Feb 2nd 2007
#-----------------------------------------------------
plot(B$Mod_Date, B$Global_reactive_power, type="n", ylab = "Global_reactive_power", xlab ="datetime")
lines(B$Mod_Date,B$Global_reactive_power)

#-----------------------------------------------------
# Step 4.5 - Closing the device
#-----------------------------------------------------
dev.off()